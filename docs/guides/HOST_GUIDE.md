...
```bash
# 先掛載遠端目錄
sshfs vboxuser@192.168.x.x:/path/to/hermes-audit /mnt/hermes-audit

# 再使用本機掛載路徑啟動
python3 agent_executor.py --db /mnt/hermes-audit/agent-mesh.db
```
...
- `../architecture/ARCHITECTURE.md` - 系統架構設計
...
3. 查看 `../architecture/ARCHITECTURE.md` 的常見問題章節
